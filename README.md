...
- 🎉 v1.0.0リリース: 初期テーマコレクションの追加、テーマ管理スクリプトの実装、ドキュメントの作成を行いました。

## ✨ 主な機能

1. **多様なテーマコレクション**: ビジネス、学術、クリエイティブなど、様々な用途に適したテーマを提供
2. **簡単なテーマ適用**: Marpマークダウンファイルに1行追加するだけでテーマを適用可能
3. **カスタマイズ支援**: 各テーマのCSSファイルを編集して、独自のスタイルを作成可能
4. **テーマ管理ツール**: テーマの追加、更新、削除を簡単に行えるスクリプトを提供
5. **サンプルプレゼンテーション**: 各テーマの使用例を示すサンプルスライドを同梱
6. **コミュニティ貢献**: ユーザーが作成したテーマを簡単に共有・統合できる仕組み
...
これらの手順により、Theme-Vault-Marpのテーマを利用してMarpプレゼンテーションを作成する環境が整います。
...
### 📘 ドキュメント
- `docs/`ディレクトリに詳細な使用方法、カスタマイズガイド、貢献方法を記載
